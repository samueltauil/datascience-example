...
oc new-app --template jupyterhub-quickstart --param APPLICATION_NAME=datascience-example --param GIT_REPOSITORY_URL=https://github.com/samueltauil/datascience-example
